# Schnellstart.md — MyceliaDB Enterprise v1.21.13
...
Ab Projektstand v1.21.13 können Bilder und sichere Medienlinks auch direkt bei der Blog-Erstellung verwendet werden.
...
Nach dem Einspielen des v1.21.13-Stands:
...
## v1.21.13 Hinweis zum PHP-blinden Betrieb
...
Dort befindet sich ab v1.21.13 das Nachrichtenmenü mit:
